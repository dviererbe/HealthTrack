...
/**
 * Implements the {@link IBloodSugarWidgetRepository} interface using an SQLite database.
 */
public class BloodSugarWidgetSQLiteRepository
        extends SQLiteOpenHelper
        implements IBloodSugarWidgetRepository
{
    private static final String DatabaseName = "BloodSugarWidget.db";
    ...
    public BloodSugarWidgetSQLiteRepository(@Nullable Context context)
    {
