...
public class SettingsViewModel implements IDisposable
{
    ...
    private final IDependencyResolver _dependencyResolver;

    public SettingsViewModel(
        final ISettingsView view,
        final IDependencyResolver dependencyResolver)
    {
        _view = view;
    ...
    public void DeleteUserData()
    {
        _view.ShowDeleteUserDataDialog((confirmDeleteAllUserData) ->
        {
            ...
            final DeleteAllUserDataOperation operation = _dependencyResolver.CreateDeleteAllUserDataOperation();
            ...
            {
                Log.d(TAG, "Failed to delete all user data", exception);
