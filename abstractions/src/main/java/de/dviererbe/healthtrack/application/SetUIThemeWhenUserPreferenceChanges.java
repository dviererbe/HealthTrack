 ...
 */
public class SetUIThemeWhenUserPreferenceChanges
{
    private final IUIThemeSetter UIThemeSetter;
    private final IPreferredThemeRepository PreferredThemeRepository;

    /**
     * Creates a new {@link SetUIThemeWhenUserPreferenceChanges} instance using the provided dependencies.
     *
     ...
     */
    public SetUIThemeWhenUserPreferenceChanges(
